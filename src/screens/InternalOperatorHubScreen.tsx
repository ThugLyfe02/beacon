        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            <View style={{ flex: 1 }}>
              ...
              <NeonText variant="bodyMuted">Adaptive command · falsifiable decision memory · exact reasoning lineage · calibration + retrospectives · assumption revalidation · evidence conflicts · collaborative Casebook rehydration · temporal coherence · Perspectives · evidence debt · ontology drift · Watchtower · routing · forensic pivots · Machines · longitudinal memory</NeonText>
            </View>
