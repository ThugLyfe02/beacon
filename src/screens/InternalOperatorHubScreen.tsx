...
const LABS: LabDefinition[] = [
  ...
  { route: 'InternalAssumptionStaleness', title: 'Assumption Staleness', code: 'REVALIDATE', description: 'Revalidates open hypotheses when canonical graph version, evidence quality, incident pressure, chronology, route diversity, or bottleneck structure materially changes. Stale means review due—not false.', capability: 'graph_manage', accent: 'accent' },
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            <View style={{ flex: 1 }}>
              ...
              <NeonText variant="bodyMuted">Adaptive command · falsifiable decision memory · calibration + retrospectives · assumption revalidation · evidence conflicts · collaborative Casebook rehydration · temporal coherence · Perspectives · evidence debt · ontology drift · Watchtower · routing · forensic pivots · Machines · longitudinal memory</NeonText>
            </View>
