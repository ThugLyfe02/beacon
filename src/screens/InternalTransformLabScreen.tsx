    ...
    <View style={styles.container}>
      ...
      <SafeAreaView edges={['top', 'bottom']} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <Section title="TRANSFORM PALETTE" subtitle="Each transform expands evidence Beacon already holds; results remain provenance-aware">
            {transforms.map((transform) => (
              <TransformCard key={transform.id} transform={transform} payload={payload} />
            ))}
          </Section>

          <Section title="MULTI-HOP EXPANSION" subtitle="Bounded graph expansion for investigative context, not hidden contact discovery">
          ...
          <Section title="EVIDENCE TIMELINE" subtitle="First/last seen chronology avoids inventing a biography from graph structure">
