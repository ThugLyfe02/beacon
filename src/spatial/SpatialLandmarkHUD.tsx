    ...
    <View pointerEvents="box-none" style={styles.wrap}>
      <View style={styles.card}>
        <View style={styles.headerRow}>
          <Text style={styles.eyebrow}>WORLD LANDMARK</Text>
        ...
        <Text style={styles.confidence}>{Math.round(state.active.confidence * 100)}% evidence confidence</Text>
        <View style={styles.controls}>
          ...
          <Pressable accessibilityRole="button" onPress={onOpen} style={[styles.button, styles.primary]}>
