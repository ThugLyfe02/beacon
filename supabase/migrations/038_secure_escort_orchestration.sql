...
-- Makes physical Office Hours handoff an atomic, lifecycle-aware control-plane
-- action rather than a loose pair of client table mutations.
-- =============================================================================

alter type public.security_action_kind add value if not exists 'escort_assignment';
...
-- Host-scoped queue read that exposes only the minimum public identity needed for
-- physical handoff. It does not depend on direct users-table RLS joins.
